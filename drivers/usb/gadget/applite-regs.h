/*
 * drivers/usb/gadget/applite-regs.h
 *
...
#ifndef __APPLITE_REGS
#define __APPLITE_REGS

/* USB2.0 OTG Controller register */
struct al_usbotg_phy {
	u32 phypwr;
	u32 phyclk;
	u32 rstcon;
};
...
struct al_usbotg_reg {
	...
	u8  res4[224];
	struct al_dev_in_endp in_endp[16];
	struct al_dev_out_endp out_endp[16];
	u8  res5[768];
...
/* UDC_OTG_GINTSTS/UDC_OTG_GINTMSK core interrupt register */
...
/* UDC_OTG_DCTL device control register */
#define NORMAL_OPERATION		(0x1<<0)
#define SOFT_DISCONNECT			(0x1<<1)
#define IGNR_FRM_NUM			(0x1<<15)

/* UDC_OTG_DAINT device all endpoint interrupt register */
#define DAINT_OUT_BIT			(16)
#define DAINT_MASK			(0xFFFF)

/* UDC_OTG_DIEPCTL0/DOEPCTL0 device
...
/* UDC_OTG_DIEPMSK/DOEPMSK device IN/OUT endpoint
   common interrupt mask register */
/* UDC_OTG_DIEPINTn/DOEPINTn device IN/OUT endpoint interrupt register */
