 ...
 * Audio Codec Driver.
 */
/*#define AIC31xx_REGULATOR*/
/*#define AIC31xx_JACK*/
#undef AIC31xx_REGULATOR
#undef AIC31xx_JACK
...
#define AIC31XX_RATES	(SNDRV_PCM_RATE_8000_192000 | SNDRV_PCM_RATE_KNOT)
...
#define HP_DEFAULT_VOL			0x92 /* -9db */
#define SPK_DEFAULT_VOL			0x92 /* -9db */
 ...
 *----------------------------------------------------------------------------
 * @struct  dac3100_priv |
 *          dac3100 private data structure to set the system clock, mode and
 *          page number.
 * @field   u32 | sysclk |
 *          system clock
 * @field   s32 | master |
 ...
 * @field   u8 | codec   |
 *          codec structure. Used while freeing the Driver Resources
 *----------------------------------------------------------------------------
 */
struct aic31xx_priv {
	u32 sysclk;
 ...
 *          Setting up the values to get different frequencies
 *
 * @field   u32 | mclk |
 *          Master clock
 * @field   u32 | rate |
 ...
 *          This structure is soc audio codec device structure which pointer
