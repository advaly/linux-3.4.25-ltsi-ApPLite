/*
 * arch/arm/mach-tz3000/include/mach/regs/i2c_reg_struct_l.h
 *
...
#ifndef _I2C_REG_STRUCT_L_H
#define _I2C_REG_STRUCT_L_H
...
struct I2C_IC4_IC_TAR {
 ...
 // IC4_IC_SAR Register
struct I2C_IC4_IC_SAR {
	unsigned int IC_TAR:10;		// [9:0]
	unsigned int reserved:22;		// [31:10]
};
 // IC4_IC_DATA_CMD Register
struct I2C_IC4_IC_DATA_CMD {
	unsigned int DAT:8;		// [7:0]
	unsigned int CMD:1;		// [8]
	unsigned int STOP:1;		// [9]
	unsigned int RESTART:1;		// [10]
...
struct I2C_IC4_IC_SS_SCL_HCNT {
	unsigned int IC_SS_SCL_HCNT:16;		// [15:0]
	unsigned int reserved:16;		// [31:16]
};
 // IC4_IC_SS_SCL_LCNT Register
struct I2C_IC4_IC_SS_SCL_LCNT {
	unsigned int IC_SS_SCL_LCNT:16;		// [15:0]
	unsigned int reserved:16;		// [31:16]
};
 // IC4_IC_FS_SCL_HCNT Register
struct I2C_IC4_IC_FS_SCL_HCNT {
	unsigned int IC_FS_SCL_HCNT:16;		// [15:0]
	unsigned int reserved:16;		// [31:16]
};
 // IC4_IC_FS_SCL_LCNT Register
struct I2C_IC4_IC_FS_SCL_LCNT {
	unsigned int IC_FS_SCL_LCNT:16;		// [15:0]
	unsigned int reserved:16;		// [31:16]
};
 // IC4_IC_INTR_STAT Register
struct I2C_IC4_IC_INTR_STAT {
	unsigned int R_RX_UNDER:1;		// [0]
	unsigned int R_RX_OVER:1;		// [1]
	unsigned int R_RX_FULL:1;		// [2]
	unsigned int R_TX_OVER:1;		// [3]
...
struct I2C_IC4_IC_RAW_INTR_STAT {
	unsigned int RX_UNDER:1;		// [0]
	unsigned int RX_OVER:1;		// [1]
	unsigned int RX_FULL:1;		// [2]
	unsigned int TX_OVER:1;		// [3]
...
struct I2C_IC4_IC_RX_TL {
	unsigned int RX_TL:8;		// [7:0]
	unsigned int reserved:24;		// [31:8]
};
 // IC4_IC_TX_TL Register
struct I2C_IC4_IC_TX_TL {
	unsigned int TX_TL:8;		// [7:0]
	unsigned int reserved:24;		// [31:8]
};
 // IC4_IC_CLR_INTR Register
struct I2C_IC4_IC_CLR_INTR {
	unsigned int CLR_INTR:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_CLR_RX_UNDER Register
struct I2C_IC4_IC_CLR_RX_UNDER {
	unsigned int CLR_RX_UNDER:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_CLR_RX_OVER Register
struct I2C_IC4_IC_CLR_RX_OVER {
	unsigned int CLR_RX_OVER:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_CLR_TX_OVER Register
struct I2C_IC4_IC_CLR_TX_OVER {
	unsigned int CLR_TX_OVER:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_CLR_RD_REQ Register
struct I2C_IC4_IC_CLR_RD_REQ {
	unsigned int CLR_RD_REQ:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_CLR_TX_ABRT Register
struct I2C_IC4_IC_CLR_TX_ABRT {
	unsigned int CLR_TX_ABRT:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_CLR_RX_DONE Register
struct I2C_IC4_IC_CLR_RX_DONE {
	unsigned int CLR_RX_DONE:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_CLR_ACTIVITY Register
struct I2C_IC4_IC_CLR_ACTIVITY {
	unsigned int CLR_ACTIVITY:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_CLR_STOP_DET Register
struct I2C_IC4_IC_CLR_STOP_DET {
	unsigned int CLR_STOP_DET:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_CLR_START_DET Register
struct I2C_IC4_IC_CLR_START_DET {
	unsigned int CLR_START_DET:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_CLR_GEN_CALL Register
struct I2C_IC4_IC_CLR_GEN_CALL {
	unsigned int CLR_GEN_CALL:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_ENABLE Register
struct I2C_IC4_IC_ENABLE {
	unsigned int ENABLE:1;		// [0]
	unsigned int ABORT:1;		// [1]
	unsigned int reserved:30;		// [31:2]
};
 // IC4_IC_STATUS Register
struct I2C_IC4_IC_STATUS {
	unsigned int ACTIVITY:1;		// [0]
	unsigned int TFNF:1;		// [1]
	unsigned int TFE:1;		// [2]
	unsigned int RFNE:1;		// [3]
...
struct I2C_IC4_IC_TXFLR {
	unsigned int TXFLR:5;		// [4:0]
	unsigned int reserved:27;		// [31:5]
};
 // IC4_IC_RXFLR Register
struct I2C_IC4_IC_RXFLR {
	unsigned int RXFLR:5;		// [4:0]
	unsigned int reserved:27;		// [31:5]
};
 // IC4_IC_SDA_HOLD Register
struct I2C_IC4_IC_SDA_HOLD {
	unsigned int IC_SDA_HOLD:16;		// [15:0]
	unsigned int reserved:16;		// [31:16]
};
 // IC4_IC_TX_ABRT_SOURCE Register
struct I2C_IC4_IC_TX_ABRT_SOURCE {
	unsigned int ABRT_7B_ADDR_NOACK:1;		// [0]
	unsigned int ABRT_10ADDR1_NOACK:1;		// [1]
	unsigned int ABRT_10ADDR2_NOACK:1;		// [2]
	unsigned int ABRT_TXDATA_NOACK:1;		// [3]
...
struct I2C_IC4_IC_SLV_DATA_NACK_ONLY {
	unsigned int NACK:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_DMA_CR Register
struct I2C_IC4_IC_DMA_CR {
	unsigned int RDMAE:1;		// [0]
	unsigned int TDMAE:1;		// [1]
	unsigned int reserved:30;		// [31:2]
};
 // IC4_IC_DMA_TDLR Register
struct I2C_IC4_IC_DMA_TDLR {
	unsigned int DMATDL:4;		// [3:0]
	unsigned int reserved:28;		// [31:4]
};
 // IC4_IC_DMA_RDLR Register
struct I2C_IC4_IC_DMA_RDLR {
	unsigned int DMARDL:4;		// [3:0]
	unsigned int reserved:28;		// [31:4]
};
 // IC4_IC_SDA_SETUP Register
struct I2C_IC4_IC_SDA_SETUP {
	unsigned int SDA_SETUP:8;		// [7:0]
	unsigned int reserved:24;		// [31:8]
};
 // IC4_IC_ACK_GENERAL_CALL Register
struct I2C_IC4_IC_ACK_GENERAL_CALL {
	unsigned int ACK_GEN_CALL:1;		// [0]
	unsigned int reserved:31;		// [31:1]
};
 // IC4_IC_ENABLE_STATUS Register
struct I2C_IC4_IC_ENABLE_STATUS {
	unsigned int IC_EN:1;		// [0]
	unsigned int SLV_DISABLED_WHILE_BUSY:1;		// [1]
	unsigned int SLV_RX_DATA_LOST:1;		// [2]
	unsigned int reserved:29;		// [31:3]
...
struct I2C_IC4_IC_FS_SPKLEN {
	unsigned int IC_FS_SPKLEN:8;		// [7:0]
	unsigned int reserved:24;		// [31:8]
};
 // IC4_IC_COMP_PARAM_1 Register
struct I2C_IC4_IC_COMP_PARAM_1 {
	unsigned int APB_DATA_WIDTH:2;		// [1:0]
	unsigned int MAX_SPEED_MODE:2;		// [3:2]
	unsigned int HC_COUNT_VALUES:1;		// [4]
	unsigned int INTR_IO:1;		// [5]
...
struct I2C_IC4_IC_COMP_VERSION {
	unsigned int IC_COMP_VERSION:32;		// [31:0]
};
 // IC4_IC_COMP_TYPE Register
struct I2C_IC4_IC_COMP_TYPE {
	unsigned int IC_COMP_TYPE:32;		// [31:0]
};
