/*
 * arch/arm/mach-tz3000/include/mach/regs/uart_reg_struct_b.h
 *
...
#ifndef _UART_REG_STRUCT_B_H
#define _UART_REG_STRUCT_B_H
...
struct UART_UA4_RBR_THR_DLL {
	unsigned int reserved:24;		// [31:8]
	unsigned int RBR_THR_DLL:8;		// [7:0]
};
 // UA4_IER_DLH Register
struct UART_UA4_IER_DLH {
	unsigned int reserved:24;		// [31:8]
	unsigned int PTIME_DLH7:1;		// [7]
	unsigned int DLH64:3;		// [6:4]
	unsigned int EDSSI_DLH3:1;		// [3]
