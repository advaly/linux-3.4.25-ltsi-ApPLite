/*
 * arch/arm/mach-tz3000/include/mach/regs/si2c0_reg_struct_b.h
 *
...
#ifndef _SI2C0_REG_STRUCT_B_H
#define _SI2C0_REG_STRUCT_B_H
...
extern  {
 ...
 // SIC0_IC_CON Register
struct SI2C0_SIC0_IC_CON {
 ...
 // SIC0_IC_TAR Register
struct SI2C0_SIC0_IC_TAR {
 ...
 // SIC0_IC_SAR Register
struct SI2C0_SIC0_IC_SAR {
	unsigned int reserved:22;		// [31:10]
	unsigned int IC_TAR:10;		// [9:0]
};
 // SIC0_IC_DATA_CMD Register
struct SI2C0_SIC0_IC_DATA_CMD {
 ...
 // SIC0_IC_SS_SCL_HCNT Register
struct SI2C0_SIC0_IC_SS_SCL_HCNT {
	unsigned int reserved:16;		// [31:16]
	unsigned int IC_SS_SCL_HCNT:16;		// [15:0]
};
 // SIC0_IC_SS_SCL_LCNT Register
struct SI2C0_SIC0_IC_SS_SCL_LCNT {
	unsigned int reserved:16;		// [31:16]
	unsigned int IC_SS_SCL_LCNT:16;		// [15:0]
};
 // SIC0_IC_FS_SCL_HCNT Register
struct SI2C0_SIC0_IC_FS_SCL_HCNT {
	unsigned int reserved:16;		// [31:16]
	unsigned int IC_FS_SCL_HCNT:16;		// [15:0]
};
 // SIC0_IC_FS_SCL_LCNT Register
struct SI2C0_SIC0_IC_FS_SCL_LCNT {
	unsigned int reserved:16;		// [31:16]
	unsigned int IC_FS_SCL_LCNT:16;		// [15:0]
};
 // SIC0_IC_INTR_STAT Register
struct SI2C0_SIC0_IC_INTR_STAT {
 ...
 // SIC0_IC_INTR_MASK Register
struct SI2C0_SIC0_IC_INTR_MASK {
	unsigned int reserved:20;		// [31:12]
 ...
 // SIC0_IC_RAW_INTR_STAT Register
struct SI2C0_SIC0_IC_RAW_INTR_STAT {
	unsigned int reserved:20;		// [31:12]
 ...
 // SIC0_IC_RX_TL Register
struct SI2C0_SIC0_IC_RX_TL {
	unsigned int reserved:24;		// [31:8]
	unsigned int RX_TL:8;		// [7:0]
};
 // SIC0_IC_TX_TL Register
struct SI2C0_SIC0_IC_TX_TL {
	unsigned int reserved:24;		// [31:8]
	unsigned int TX_TL:8;		// [7:0]
};
 // SIC0_IC_CLR_INTR Register
struct SI2C0_SIC0_IC_CLR_INTR {
	unsigned int reserved:31;		// [31:1]
	unsigned int CLR_INTR:1;		// [0]
};
 // SIC0_IC_CLR_RX_UNDER Register
struct SI2C0_SIC0_IC_CLR_RX_UNDER {
	unsigned int reserved:31;		// [31:1]
	unsigned int CLR_RX_UNDER:1;		// [0]
};
 // SIC0_IC_CLR_RX_OVER Register
struct SI2C0_SIC0_IC_CLR_RX_OVER {
	unsigned int reserved:31;		// [31:1]
	unsigned int CLR_RX_OVER:1;		// [0]
};
 // SIC0_IC_CLR_TX_OVER Register
struct SI2C0_SIC0_IC_CLR_TX_OVER {
	unsigned int reserved:31;		// [31:1]
	unsigned int CLR_TX_OVER:1;		// [0]
};
 // SIC0_IC_CLR_RD_REQ Register
struct SI2C0_SIC0_IC_CLR_RD_REQ {
	unsigned int reserved:31;		// [31:1]
	unsigned int CLR_RD_REQ:1;		// [0]
};
 // SIC0_IC_CLR_TX_ABRT Register
struct SI2C0_SIC0_IC_CLR_TX_ABRT {
	unsigned int reserved:31;		// [31:1]
	unsigned int CLR_TX_ABRT:1;		// [0]
};
 // SIC0_IC_CLR_RX_DONE Register
struct SI2C0_SIC0_IC_CLR_RX_DONE {
	unsigned int reserved:31;		// [31:1]
	unsigned int CLR_RX_DONE:1;		// [0]
};
 // SIC0_IC_CLR_ACTIVITY Register
struct SI2C0_SIC0_IC_CLR_ACTIVITY {
	unsigned int reserved:31;		// [31:1]
	unsigned int CLR_ACTIVITY:1;		// [0]
};
 // SIC0_IC_CLR_STOP_DET Register
struct SI2C0_SIC0_IC_CLR_STOP_DET {
	unsigned int reserved:31;		// [31:1]
	unsigned int CLR_STOP_DET:1;		// [0]
};
 // SIC0_IC_CLR_START_DET Register
struct SI2C0_SIC0_IC_CLR_START_DET {
	unsigned int reserved:31;		// [31:1]
	unsigned int CLR_START_DET:1;		// [0]
};
 // SIC0_IC_CLR_GEN_CALL Register
struct SI2C0_SIC0_IC_CLR_GEN_CALL {
	unsigned int reserved:31;		// [31:1]
	unsigned int CLR_GEN_CALL:1;		// [0]
};
 // SIC0_IC_ENABLE Register
struct SI2C0_SIC0_IC_ENABLE {
	unsigned int reserved:30;		// [31:2]
	unsigned int reserved2:1;		// [1]
	unsigned int ENABLE:1;		// [0]
};
 // SIC0_IC_STATUS Register
struct SI2C0_SIC0_IC_STATUS {
	unsigned int reserved:25;		// [31:7]
 ...
 // SIC0_IC_TXFLR Register
struct SI2C0_SIC0_IC_TXFLR {
	unsigned int reserved:27;		// [31:5]
	unsigned int TXFLR:5;		// [4:0]
};
 // SIC0_IC_RXFLR Register
struct SI2C0_SIC0_IC_RXFLR {
	unsigned int reserved:27;		// [31:5]
	unsigned int RXFLR:5;		// [4:0]
};
 // SIC0_IC_SDA_HOLD Register
struct SI2C0_SIC0_IC_SDA_HOLD {
	unsigned int reserved:16;		// [31:16]
	unsigned int IC_SDA_HOLD:16;		// [15:0]
};
 // SIC0_IC_TX_ABRT_SOURCE Register
struct SI2C0_SIC0_IC_TX_ABRT_SOURCE {
	unsigned int reserved:16;		// [31:16]
 ...
 // SIC0_IC_SLV_DATA_NACK_ONLY Register
struct SI2C0_SIC0_IC_SLV_DATA_NACK_ONLY {
	unsigned int reserved:31;		// [31:1]
	unsigned int NACK:1;		// [0]
};
 // SIC0_IC_SDA_SETUP Register
struct SI2C0_SIC0_IC_SDA_SETUP {
	unsigned int reserved:24;		// [31:8]
	unsigned int SDA_SETUP:8;		// [7:0]
};
 // SIC0_IC_ACK_GENERAL_CALL Register
struct SI2C0_SIC0_IC_ACK_GENERAL_CALL {
	unsigned int reserved:31;		// [31:1]
	unsigned int ACK_GEN_CALL:1;		// [0]
};
 // SIC0_IC_ENABLE_STATUS Register
struct SI2C0_SIC0_IC_ENABLE_STATUS {
 ...
 // SIC0_IC_FS_SPKLEN Register
struct SI2C0_SIC0_IC_FS_SPKLEN {
	unsigned int reserved:24;		// [31:8]
	unsigned int IC_FS_SPKLEN:8;		// [7:0]
};
 // SIC0_IC_COMP_PARAM_1 Register
struct SI2C0_SIC0_IC_COMP_PARAM_1 {
 ...
 // SIC0_IC_COMP_VERSION Register
struct SI2C0_SIC0_IC_COMP_VERSION {
	unsigned int IC_COMP_VERSION:32;		// [31:0]
};
 // SIC0_IC_COMP_TYPE Register
struct SI2C0_SIC0_IC_COMP_TYPE {
