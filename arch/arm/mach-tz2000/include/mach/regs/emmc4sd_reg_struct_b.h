/*
 * arch/arm/mach-tz2000/include/mach/regs/emmc4sd_reg_struct_b.h
 *
...
#ifndef _EMMC4SD_REG_STRUCT_B_H
#define _EMMC4SD_REG_STRUCT_B_H
...
struct EMMC4SD_SDMA_SYSTEM_ADDRESS_ARGUMENT_2 {
	unsigned int SDMA_System_Address_Argument_2:32;		// [31:0]
};
 // Block_Count_Block_Size Register
struct EMMC4SD_BLOCK_COUNT_BLOCK_SIZE {
...
struct EMMC4SD_WAKEUP_CONTROL_BLOCK_GAP_CONTROL_POWER_CONTROL_HOST_CONTROL_1 {
...
struct EMMC4SD_SOFTWARE_RESET_TIMEOUT_CONTROL_CLOCK_CONTROL {
	unsigned int Reserved:5;		// [31:27]
...
struct EMMC4SD_ERROR_INTERRUPT_STATUS_NORMAL_INTERRUPT_STATUS {
...
struct EMMC4SD_ERROR_INTERRUPT_STATUS_ENABLE_NORMAL_INTERRUPT_STATUS_ENABLE {
...
struct EMMC4SD_ERROR_INTERRUPT_SIGNAL_ENABLE_NORMAL_INTERRUPT_SIGNAL_ENABLE {
...
struct EMMC4SD_HOST_CONTROL_2_AUTO_CMD_ERROR_STATUS {
...
struct EMMC4SD_MAXIMUM_CURRENT_CAPABILITIES {
...
struct EMMC4SD_FORCE_EVENT_FOR_ERROR_INTERRUPT_STATUS_FORCE_EVENT_FOR_AUTO_CMD_ERROR_STATUS {
...
struct EMMC4SD_ADMA_ERROR_STATUS {
...
struct EMMC4SD_PRESET_VALUE_FOR_SDR12_HIGH_SPEED {
...
struct EMMC4SD_PRESET_VALUE_FOR_SDR50_SDR25 {
...
struct EMMC4SD_PRESET_VALUE_FOR_DDR50_SDR104 {
